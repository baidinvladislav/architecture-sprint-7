...
3. Финансовая система (Accountant-сервис)
...
| **5. Управление изменениями и уязвимостями** | Недавно в ИТ-командах произошли изменения. Возможно, новые разработчики допустили ошибки, которые угрожают безопасности. Нужно проверить процесс внесения изменений. |
